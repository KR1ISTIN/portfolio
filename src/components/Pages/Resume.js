      ...
      <div style={{ background: "	#FAF9F6" }} class="container">
        <div class="row">
            ...
            <div class="container">
              <div class="row">
                <a
                  ...
                  target="_blank"
                  href="https://github.com/KR1ISTIN"
                >
                  Github: KR1ISTIN
                </a>
              </div>
              <div class="row">
                <a
                  style={styles.contact}
                  target="_blank"
                  href="https://www.linkedin.com/in/kristin-desalme/"
                >
                  LinkedIn
                </a>
              </div>
          ...
          <div class="container text-center">
            ...
            <div class="row">
              <div class="col-sm-12">
                <strong>Languages:</strong> Java, JavaScript, SQL, HTML5, BASH
              </div>
              <p />
              <div class="col-sm-12">
                <strong>Frameworks/Libraries: </strong>Spring, Spring Boot,
                Spring Security, Node.js, Express.js, React, Handlebars,
                Bootstrap, MaterialUI, Bulma, Tailwind
              </div>
              <p />
              <div class="col-sm-12">
            ...
            <h5 style={{ paddingTop: "1em", letterSpacing: ".5em" }}>
              Experience
            </h5>
            <div class="row">
              <div style={{ padding: "1em" }} class="col-sm-12">
                {" "}
                <strong>
                  ARP Roofing and Remodeling: Backend Developer <br />
                  2024-Present
                  <br />
                </strong>
                Contracted to create an app that is a central source for
                customer related data.
                <div style={{ paddingTop: "1em" }} class="row">
                  <div class="col-sm-4">
                    <strong>Key Accomplishments/In Progess:</strong>
                  </div>
                  <div class="col-sm-8">
                    <ul style={{ textAlign: "start" }}>
                      <li>
                        <em>Reduced</em> latency in lead creation by enabling
            ...
            <div class="row">
              <div style={{ padding: "1em" }} class="col-sm-12">
                {" "}
                <strong>
                  HelloCure: FullStack Developer <br />
                  2023-Present
                  <br />
                </strong>
                Volunteering to help a childhood cancer nonprofit. Built a
                key-single page featuring update operations, database
                consultation and implementation, and mentoring in Git versioning
                control, and maintenance in code base.
                <div style={{ paddingTop: "1em" }} class="row">
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-8">
                    <ul style={{ textAlign: "start" }}>
                      <li>
                        <em>Collaborated</em> with team to refine database
                        architecture, ensuring <em>efficiency</em>
                      </li>
                      <li>
                        <em>Successfully</em> trained my partner in Git
                        versioning control, fostering <em>collaborative</em> and
                        efficient development environments
                      </li>
                      <li>
                        <em>Successfully</em> implemented RESTful APIs using
                        Django and Python between HelloCure and Stripe
                      </li>
                      <li>
            ...
            <div class="row">
              <div class="col-sm-12">
                {" "}
                <h6>
                  <strong>Yard Gems</strong>
                  <br></br>
                  <a
                    style={{ color: "black", paddingRight: "10px" }}
                    href="https://yardgems-15b0faee737f.herokuapp.com/"
                  >
                    Project Link
                  </a>
                  <a
                    style={{ color: "black" }}
                    href="https://github.com/Omar4589/YardGems"
                  >
                    Github Link
                  </a>
                  <br />A team project, utilizing the MERN Stack. Allowing users
                  to search and post garage sales
                </h6>
                <div style={{ padding: "1em" }} class="row">
                  <div class="col-sm-4">
                    <strong>
                      Role: FullStack Development and Project Management
                    </strong>{" "}
                    Implemented React Google Maps API, Models, GraphQL, Routes
                    for CRUD both front and backend, secure Login/Logout
                    functionality, partial implementation UI design, Scrum
                    Master
                  </div>
                  <div class="col-sm-8" style={{ textAlign: "left" }}>
                    <strong>Tools/Technologies:</strong> React, React Router
                    DOM, Heroku, Mongoose, JavaScript, React Google Maps API,
                    GraphQL, MaterialUI, Express.js, Node.js, Apollo Server,
                    JWT, Bycrpt, HTML, CSS, Team Collaboration, Agile
                    Development, Kanban, Scrum, Paired Programming, Git, Github
                    Projects, Wireframe
                  </div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                {" "}
                <h6>
                  <strong>Meal Mappr</strong>
                  <br></br>
                  <a
                    style={{ color: "black", paddingRight: "10px" }}
                    href="https://mealmappr.herokuapp.com/"
                  >
                    Project Link
                  </a>
                  <a
                    style={{ color: "black" }}
                    href="https://github.com/Rolyat512/MealMappr"
                  >
                    Github Link
                  </a>
                  <br></br>MealMappr, a team project, that allows access for
                  users to manage their personalized meal plans
                </h6>
                <div style={{ padding: "1em" }} class="row">
                  <div class="col-sm-4">
                    <strong>
                    ...
                    Implemented Models, Routes for CRUD both front and backend,
                    Login/Logout functionality , Scrum Master, UI design for
                    modals{" "}
                  </div>
                  <div class="col-sm-8" style={{ textAlign: "left" }}>
                    <strong>Tools/Technologies:</strong> Heroku, HTML,
                    JavaScript, Node, Express, Sequelize, Handlebars, TailWind,
                    Full Calendar, Bycrpt, Team Collaboration, Agile
                    Development, KanBan, Scrum, Paired Programming, Git, Github
                    Projects, Wireframe
                  </div>
                </div>
            ...
            <div class="row">
              <div style={{ paddingBottom: "1.5em" }} class="col-sm-12">
                ...
                AOP, with the addition of Docker and Microservices
                <br /> May 2024
              </div>
              <div style={{ paddingBottom: "1.5em" }} class="col-sm-12">
              ...
              <div style={{ paddingBottom: "1.5em" }} class="col-sm-12">
                <h6>Associate, Dental Hygiene: Concorde Career College</h6>A
                18-month accelerated program, focusing on oral hygiene and
                clinical care
                <br></br> April 2017
              </div>
            </div>
